...
Private Sub HandleAddModal
	...
	select1.Initialize
	select1.Append(CRLF).Append($"      <select class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-sky-500 outline-none appearance-none" id="category2" name="category" required>"$)
	...
	AddModal = AddModal.Replace($"<select class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 outline-none transition-all appearance-none" id="category1" name="category" required></select>"$, select1.ToString)
...
Private Sub HandleEditModal
	...
	EditModal = EditModal.Replace($"<select class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 outline-none transition-all appearance-none" id="category2" name="category" required></select>"$, select1.ToString)
